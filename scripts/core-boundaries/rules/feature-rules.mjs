...
export const optionalDependencyFeatureOwnerRules = [
  ...
  },
  {
    ...
    dependencies: [
      ...
      { depName: 'sha2', ownerFeatures: ['canvas-runtime', 'miniapp-runtime', 'plugin-source', 'remote-connect', 'remote-ssh', 'review-platform'] },
      ...
      { depName: 'tempfile', ownerFeatures: ['miniapp-runtime'] },
      ...
      { depName: 'zip', ownerFeatures: ['miniapp-runtime'] },
    ],
  },
  {
